...
use omv_primitives::{account_address::AccountAddress, language_storage::CORE_CODE_ADDRESS};
use omc_ir_to_bytecode::{
    compiler::{compile_module, compile_script},
    parser::{parse_module, parse_script},
};
use omc_ir_types::location::Loc;
use std::mem;
use omv_core::file_format::{CompiledModule, CompiledScript};
